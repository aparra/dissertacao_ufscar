...
Alguns aspecto precisam ser considerados para a operação de inclusão de uma nova réplica
em um aglomerado: (1) o estado da nova réplica está defasado com relação ao estado das
...
para o processamento do aglomerado deve ser mínimo. Para justificar a inclusão de uma
nova réplica, obrigatoriamente é preciso geração de benefícios para o processamento em
grupo, caso contrário estamos executando operações de saturação sem benefícios.
...
Para que a inclusão de uma nova réplica seja produtiva \footnote{Inclusões produtivas são
operações que aumentam a capacidade de processamento do sistema com o mínimo de impacto},
é preciso realizar a transferência completa de um estado inicial que deve ser clonado de
outra réplica já ativa, votante ou leitora. Por questões de garantia de consistência, a transferência de
