...
WeakSecretary apresenta uma abstração de I/O sem persistência de dados em disco. Esse
componente é uma versão leve da classe Secretary (\autoref{subsec:secretary}), ele é
utilizado pelos agentes de Paxos para o enviar de mensagens pela rede, através do
intermédio do componente Transport (\autoref{subsec:transport}). Como as instâncias dessa
classe trabalham com dados somente em memória, todos os dados armazenados são perdidos na
presença de defeitos. No entanto, na ausência de falhas eliminamos a operação custosa de
I/O em disco.

Essa classe também é responsável por lidar com o Ledger e com a fila de objetos utilizada
...
\subsubsubsection{StrongSecretary}
  - ChangeLog

\subsubsubsection{PaxosReadonlyQueue}
  - WeakSecretary

\subsubsubsection{PaxosPersistenteQueue}
  - Election
  - Coordinator
  - Acceptor
  - StrongSecretary
