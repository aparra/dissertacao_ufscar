...
mensagem \classname{DealMessage} somente para a réplica receptora (remetente da mensagem
...
ela reinicia a Fase de Negociação. Utilizando-se dessa premissa, podemos criar diferentes
politicas contratuais para receber um estado, lembrando que todas as politicas devem
informar qual a instância de consenso pretendida. Nessa versao proposta de Treplica,
configuramos duas politicas:
...
Quando iniciamos uma réplica leitora ela difunde uma mensagem (PredicateMessage) com o
