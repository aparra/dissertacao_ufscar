...
ilustra a \autoref{fig:nucleo_replicas_votantes}.

\begin{figure}[ht]
\centering
\begin{minipage}[b]{0.45\linewidth}
  \includegraphics{conteudo/capitulos/figuras/nucleo_replicas_votantes.eps}
  \includegraphics...
...
\quad
\begin{minipage}[b]{0.45\linewidth}
  \includegraphics{conteudo/capitulos/figuras/mix_replicas_leitoras_votantes.eps}
  \caption{Mix com réplicas votante e leitoras}
  \label{fig:mix_replicas_leitoras_votantes}
\end{minipage}
\end{figure}
