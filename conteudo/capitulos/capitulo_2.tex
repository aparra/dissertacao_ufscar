...
A abstracao de transporte eh definida pela interface \classname{Transport}. Ele oferece a
...
O agente receptor aguarda pela mensagem da Fase 1a que inicia uma nova rodada de consenso
