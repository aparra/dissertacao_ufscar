...
classes \classname{PolicyMessage}, \classname{DealMessage}, \classname{GetMessage} e
\classname{StateMessage}. Todas essas classes implementam a interface de marcacao
\classname{StateTransferMessage}, possibilidando assim, distinguir as mesagens do
protocolo das mensages de Paxos.

Todas as mensages do protocolo sao roteadas no {main loop} de cada replica para a classe
\classname{Diplomat}, responsavel pelo tratamento dessas mensagens, independente da
...
A classe \classname{Diplomat} eh reponsavel por implementar o tratamento das mensagens do
...
\citeonline{lamport10} apresenta em seu trabalho um mecanismo para reconfiguracao que pode
...
Investimos nosso esforco na construcao de um mecanismo que fugia da complexidade do
...
\subsection{Transferencia de estado para recuperacao de falhas}
